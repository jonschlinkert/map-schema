...
module.exports = {
  ...
  unknownField: function(warning) {
    return 'invalid property: "' + warning.prop + '". When `options.knownOnly` is true, only properties with fields defined on the schema may be used.';
  },
